...
shinyUI(fluidPage(
  tags$head(HTML(
    ...
    <script async src='https://www.googletagmanager.com/gtag/js?id=UA-151675394-1'></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'UA-151675394-1');
    </script>"
  )),
             ...
             tabPanel("Model Inputs and Outputs / စံပြုပုံစံ သွင်းအားစု နှင့် ရလဒ်",
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          selectInput("siteAnalysis",label="Select site / နေရာရွေးချယ်ရန်",choices=c("Rakhine", "Delta", "Tanintharyi"),selected="Tanintharyi"),
